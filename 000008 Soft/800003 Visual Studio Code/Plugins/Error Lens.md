ErrorLens ускоряет функции языковой диагностики, делая диагностику более заметной, выделяя всю строку везде, где диагностика генерируется языком, а также печатая сообщение встроенным.
